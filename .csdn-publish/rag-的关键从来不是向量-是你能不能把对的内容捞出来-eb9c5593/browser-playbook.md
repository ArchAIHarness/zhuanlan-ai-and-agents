# CSDN 浏览器操作手册：RAG 的关键从来不是向量——是你能不能把对的内容捞出来
...
| 占位符 | 文件路径 | alt 文本 |
|--------|----------|----------|
| @@@IMG_0@@@ | assets/09_RAG的关键从来不是向量/01-retrieval-is-the-core.png | RAG 三步骤：命门在检索，向量只是手段 |
| @@@IMG_1@@@ | assets/09_RAG的关键从来不是向量/02-chef-needs-scallion.png | 检索不是越多越好，是越准越好：厨子要葱 vs 端来一冰箱 |
| @@@IMG_2@@@ | assets/09_RAG的关键从来不是向量/03-catalog-as-retrieval-path.png | 目录本身就是检索路径：人怎么分类，AI 就怎么找 |
| @@@IMG_3@@@ | assets/09_RAG的关键从来不是向量/04-map-progressive-disclosure.png | 渐进式披露：先读总览地图，再进一层读小地图，定位到那一篇才打开 |
