...
![上下文窗口就是 AI 每次能看到的那张有限的纸](assets/context-engineering/02-context-window-paper.png)
...
![Token 是 AI 眼里的字符块，纸装满会把旧内容挤出去](assets/context-engineering/03-token-and-overflow.png)
...
![上下文不是越长越好，而是越相关越好](assets/context-engineering/04-relevant-vs-long.png)
...
![上下文工程在 Agent 闭环中的位置](assets/context-engineering/05-context-in-agent-loop.png)
