...
![办公桌三层全景：桌面（工作记忆）、抽屉（短期记忆）、档案柜（长期记忆）](assets/ai-memory/00-three-layer-desk.png)
...
![工作记忆就像办公桌桌面，空间有限](assets/ai-memory/01-desktop-workbench.png)
...
![短期记忆像抽屉，装会话内的历史；长期记忆像档案柜，装跨会话的知识](assets/ai-memory/02-desk-drawer.png)
...
![档案柜的组织方式决定AI能找到什么——有标签的档案柜比乱堆有效得多](assets/ai-memory/03-bookshelf-organized.png)
...
![三种长期记忆组织方式，覆盖从个人到团队到开发者的递进需求](assets/ai-memory/04-three-case-logic.png)

## 五、三层联动，一张图看懂

![三层记忆如何协作完成一个任务——办公桌全景](assets/ai-memory/05-three-layer-overview.png)
