...
![framework = 一座已经搭好的厨房,新服务搬走直接开干](assets/32_framework整合实战——DDD-TDD-SDD三件套在framework仓的真实落地/01.png)
...
![framework 六模块分层铁律,业务边界 = 模块边界,最底 domain + common 红色钢门焊死](assets/32_framework整合实战——DDD-TDD-SDD三件套在framework仓的真实落地/02.png)
...
![JaCoCo ≥ 90% 强制覆盖率闸门,P0 红灯亮起闸门关闭,试菜员举 Given-When-Then 强制标牌](assets/32_framework整合实战——DDD-TDD-SDD三件套在framework仓的真实落地/03.png)
...
![双文档体系对照:readme.md 给人看 + AGENTS.md 给 AI 看,上方 Spec 端长期挂载](assets/32_framework整合实战——DDD-TDD-SDD三件套在framework仓的真实落地/04.png)
...
![硬秩序焊边界(三个限界上下文钢铁墙)+ 软秩序放选择(6 个 SPI 旋转门),AI 列车在铁桥上平稳通过](assets/32_framework整合实战——DDD-TDD-SDD三件套在framework仓的真实落地/05.png)
