...
- [`assets/02_Agent到底是什么/`](./assets/02_Agent到底是什么/)：Agent 执行系统文章配图，第 2 篇与第 8 篇共用（02 = 聊天vs干活对比，03 = 执行循环，04 = 工具权限边界，05 = 失败模式）。
...
- [`assets/自主推理框架/`](./assets/自主推理框架/)：自主推理框架备用素材（01 = 导航类比，02 = ReAct循环，03 = 思维链，04 = 人工接管点），第 8 篇资源目录待按文章名规范化。
