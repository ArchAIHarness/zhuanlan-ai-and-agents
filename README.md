...
- **普通人/业务岗**：希望系统理解 AI 和 Agent，会用、能避坑，不被概念绕晕。
- **工程师/架构师**：想接住底层逻辑，知道工程化要做什么，不只是调 API。

它不从数学公式或模型论文切入，而是用你身边就有的概念把这个领域讲透。每篇一个核心比喻贯穿全文——纸、手、工位、契约、工具包、搭子、办公桌——从日常经验直接推导出技术结论。

前 7 篇完成了从模型生成、Agent 执行、上下文约束、外部能力体系、提示词契约、实操落地到记忆体系的完整认知闭环。后续将进入自主推理、知识库检索、多 Agent 协作等工程深耕板块。

> **架构师定义秩序，AI 在秩序中生长。人立法，AI 执行，体系审计。**

本专栏是 [ArchAIHarness](https://github.com/ArchAIHarness) 人机协同架构哲学在内容创作侧的具体落地。每一篇文章本身就是一次"人定义目标和边界，AI 在边界内执行"的实践。
