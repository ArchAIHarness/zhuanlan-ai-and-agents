...
71 期讲的那个律师 SaaS 平台，被罚 5000 美元后，痛定思痛。
...
**反常识金句 1（72 期版）：四道闸不是装来防 AI 的，是装来防自己的。**

换句话说——**四道闸的本质不是约束 AI，是约束人对 AI 的信任**。

71 期讲过的那个 Mata 案里，律师 Schwartz 之所以被罚 5000 美元，根因不是 ChatGPT 编造了判例——根因是 Schwartz **完全相信了 ChatGPT 的输出而没核查**。
...
71 期讲的那个律师 SaaS 平台，被罚 5000 美元那晚，月度违规生成 12 万次、法律函件 1 起、品牌跌 73%、融资砍半。这是 3 个月前的数字。
...
这就是 72 期和 71 期最大的差别——71 期讲"为什么要装门禁"，72 期讲"门禁怎么装"。
...
**反常识金句 2（72 期版）：RAG 不是越大越好，是越准越好。**
...
**反常识金句 3（72 期版）：引用溯源标注不是给 AI 看的，是给用户看的。**
...
71 期讲过那个律师 SaaS 平台的复盘——他们上线引用溯源标注后，客户投诉率下降 92%。**其中 50% 的下降来自"用户能直接看到 AI 引用的出处，自己能核查"**——而不是"AI 标注完出处所以更准了"。
...
**反常识金句 4（72 期版）：置信度评分的最大价值不是识别幻觉，是让 AI 学会"不知道"。**
...
**反常识金句 5（72 期版）：兜底话术不是降低用户体验，是保护用户体验。**
...
**反常识金句 6（72 期版）：RAG 工程化不是技术问题，是业务问题。**
...
71 期我们讲了"AI 幻觉是什么、为什么必然存在"，72 期我们讲了"怎么用工程纪律兜住"。这一对双篇组合的核心命题是——**AI 时代真正的护城河，不是模型能力，是工程纪律**。
