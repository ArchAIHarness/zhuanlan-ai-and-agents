...
![模糊输入只能得到模糊输出](assets/05_别再找Prompt模板了/02-fuzzy-input-fuzzy-output.png)
...
![提示词是给模型划定预测的前提范围](assets/05_别再找Prompt模板了/03-prompt-as-prediction-boundary.png)
...
![一个好 Prompt 的五个零件](assets/05_别再找Prompt模板了/04-five-components-of-good-prompt.png)
...
![Prompt 是人和 AI 之间的接口契约](assets/05_别再找Prompt模板了/06-prompt-as-interface-contract.png)
