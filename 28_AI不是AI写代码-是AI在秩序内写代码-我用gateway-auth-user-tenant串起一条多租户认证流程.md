# AI 不是 AI 写代码，是 AI 在秩序内写代码——我用 gateway + auth + user + tenant 串起一条多租户认证流程
...
![开篇反差：放手让 AI 跑 vs 在赛道里让 AI 跑](assets/28_AI不是AI写代码-是AI在秩序内写代码-我用gateway-auth-user-tenant串起一条多租户认证流程/01-loose-vs-track.png)
...
![完整分层图：三个限界上下文 + 一个平台层 + 共享内核](assets/28_AI不是AI写代码-是AI在秩序内写代码-我用gateway-auth-user-tenant串起一条多租户认证流程/02-four-components-layered.png)
...
![链路 A 时序图：client → gateway → auth → user 的客户-供应商映射](assets/28_AI不是AI写代码-是AI在秩序内写代码-我用gateway-auth-user-tenant串起一条多租户认证流程/03-link-a-sequence.png)
...
![链路 B 时序图：Token 校验 + 多租户透传，gateway 防腐层](assets/28_AI不是AI写代码-是AI在秩序内写代码-我用gateway-auth-user-tenant串起一条多租户认证流程/04-link-b-sequence.png)
...
![链路 C 时序图：tenant → Kafka → user 的发布-订阅 + 幂等保证](assets/28_AI不是AI写代码-是AI在秩序内写代码-我用gateway-auth-user-tenant串起一条多租户认证流程/05-link-c-sequence.png)
...
![硬秩序 vs 软秩序：三个限界上下文焊边界 vs 平台层放选择](assets/28_AI不是AI写代码-是AI在秩序内写代码-我用gateway-auth-user-tenant串起一条多租户认证流程/06-hard-vs-soft-rules.png)
