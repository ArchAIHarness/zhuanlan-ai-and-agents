...
![乐谱与乐团：架构师写乐谱，AI 演奏交响乐](assets/27_DDD、TDD、SDD——AI时代工程师的三件秩序乐器/01-sheet-music-and-orchestra.png)
...
![三个失控现场：凭印象写实体 / 跳过测试 / 文档当摆设](assets/27_DDD、TDD、SDD——AI时代工程师的三件秩序乐器/02-three-loss-of-control.png)
...
![同一套秩序两种表达：readme 给人看，AGENTS.md 给 AI 看](assets/27_DDD、TDD、SDD——AI时代工程师的三件秩序乐器/03-two-layer-docs.png)
...
![硬规范与软秩序：边界焊死与选择放开的对照](assets/27_DDD、TDD、SDD——AI时代工程师的三件秩序乐器/04-hard-rules-vs-soft-rules.png)
