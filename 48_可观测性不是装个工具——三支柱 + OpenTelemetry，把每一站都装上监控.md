...
![图片占位](assets/48_可观测性不是装个工具——三支柱加OpenTelemetry把每一站都装上监控/1-metrics-dashboard.png)
...
![图片占位](assets/48_可观测性不是装个工具——三支柱加OpenTelemetry把每一站都装上监控/2-structured-logs.png)
...
![图片占位](assets/48_可观测性不是装个工具——三支柱加OpenTelemetry把每一站都装上监控/3-trace-flow.png)
...
![图片占位](assets/48_可观测性不是装个工具——三支柱加OpenTelemetry把每一站都装上监控/4-sampling-strategy.png)
...
![图片占位](assets/48_可观测性不是装个工具——三支柱加OpenTelemetry把每一站都装上监控/5-alert-pipeline.png)
