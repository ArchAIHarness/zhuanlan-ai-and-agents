...
![老师一句话原始需求,从口语化到 AI 准备追问的全过程](assets/33_老师想AI帮忙做课——AI却问了一堆离谱的问题——我才明白真懂业务的是人不是AI/01-raw-requirement-bubble-and-laptop.png)
...
![AI 按 ADD 8 维度追问、3 轮覆盖的雷达图](assets/33_老师想AI帮忙做课——AI却问了一堆离谱的问题——我才明白真懂业务的是人不是AI/02-radar-add-eight-dimensions.png)
...
![4 轮追问 + 1 轮汇总确认的对话时间线,最右挂着红色汇总闸](assets/33_老师想AI帮忙做课——AI却问了一堆离谱的问题——我才明白真懂业务的是人不是AI/03-dialogue-timeline-with-summary-gate.png)
...
![标准化课程业务模型 JSON 的 9 字段 + 嵌套 4 层树状图](assets/33_老师想AI帮忙做课——AI却问了一堆离谱的问题——我才明白真懂业务的是人不是AI/04-json-knowledge-tree.png)
...
![老师、FDE、AI 三方对话协作关系图,FDE 在中间做业务翻译官](assets/33_老师想AI帮忙做课——AI却问了一堆离谱的问题——我才明白真懂业务的是人不是AI/05-fde-three-way-collaboration.png)
